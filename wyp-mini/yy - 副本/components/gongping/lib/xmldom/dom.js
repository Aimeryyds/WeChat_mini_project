...
function t(t, n) {
    ...
    if (!(r instanceof n)) {
        var o = function() {};
        o.prototype = n.prototype, e(r, o = new o()), t.prototype = r = o;
    }
...
}, F = "http://www.w3.org/1999/xhtml", Y = {}, z = Y.ELEMENT_NODE = 1, $ = Y.ATTRIBUTE_NODE = 2, X = Y.TEXT_NODE = 3, G = Y.CDATA_SECTION_NODE = 4, H = Y.ENTITY_REFERENCE_NODE = 5, W = Y.ENTITY_NODE = 6, q = Y.PROCESSING_INSTRUCTION_NODE = 7, Z = Y.COMMENT_NODE = 8, Q = Y.DOCUMENT_NODE = 9, J = Y.DOCUMENT_TYPE_NODE = 10, K = Y.DOCUMENT_FRAGMENT_NODE = 11, ee = Y.NOTATION_NODE = 12, te = {}, ne = {}, re = (te.INDEX_SIZE_ERR = (ne[1] = "Index size error", 
...
}, e(Y, p), e(Y, p.prototype), d.prototype = {
    nodeName: "#document",
    nodeType: Q,
    doctype: null,
...
t(y, p), b.prototype.nodeType = $, t(b, p), T.prototype = {
    data: "",
    ...
    nodeType: G
}, t(D, T), C.prototype.nodeType = J, t(C, p), I.prototype.nodeType = ee, t(I, p), 
x.prototype.nodeType = W, t(x, p), A.prototype.nodeType = H, t(A, p), R.prototype.nodeName = "#document-fragment", 
R.prototype.nodeType = K, t(R, p), O.prototype.nodeType = q, t(O, p), U.prototype.serializeToString = function(e, t, n) {
    return M.call(e, t, n);
