...
Page({
    ...
    setTabBar: function(t) {
        ...
        }), a = "" != n.font_color ? n.font_color : "#ffffff", e = "" != n.head_color ? n.head_color : n.tcolor, 
        wx.setNavigationBarColor({
            frontColor: a,
            backgroundColor: e
        });
        var i = getCurrentPages(), r = i[i.length - 1], n = this.data.blist;
        r.options.id == t && (n.isCurrentPage = !0);
        var o = new Array(n.m1_path, n.m2_path, n.m3_path, n.m4_path), s = 0;
        for (var c in o) o[c] == "a" + t && (s = parseInt(c) + 1);
