...
Page({
    ...
    loadData: function(a) {
        var d = this, t = app.siteInfo.uniacid, e = d.data.tid, i = d.data.fid;
        app.util.request({
            ...
            success: function(a) {
                if (!a.data.errno) {
                    ...
                    if (d.data.currentCatId != e ? (console.log(d.data.currentCatId + "---" + e), d.setData({
                        ...
                        var i = d.data.lastid + 8;
                        d.setData({
                            lastid: i
                        });
                        var r = d.data.list.concat(a.data.data.list);
                        d.setData({
                            list: r
                        });
                    }
    ...
    setTabBar: function(a) {
        ...
        for (var o in n) n[o] == a && (s = parseInt(o) + 1);
