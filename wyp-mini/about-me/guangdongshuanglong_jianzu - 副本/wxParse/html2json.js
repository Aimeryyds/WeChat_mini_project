    ...
    html2json: function(e, a) {
        ...
        return l(e, {
            start: function(e, t, r) {
                ...
                }, {})), "img" === l.tag && (l.imgIndex = n.images.length, p = l.attr.src, p = i.urlToHttpUrl(p, s), 
                l.attr.src = p, l.from = a, n.images.push(l), n.imageUrls.push(p)), "video" === l.tag) {
                    var p = l.attr.src;
                    p = i.urlToHttpUrl(p, s), l.attr.src = p, l.from = a, n.videos.push(l);
                }
                if ("font" === l.tag) {
