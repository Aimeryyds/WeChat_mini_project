    ...
    methods: {
        ...
        queryGoodsList: function(t, a, o) {
            ...
            a && wx.showLoading({
                title: "请稍候",
                mask: !0
            }), e.default.queryStoreGoodsList(d).then(function(e) {
                a && wx.hideLoading();
                ...
                var l = s.data.shopDefault;
                l.totalNumber = e.data.total, l.selectGood = null, l.isloadingmore = !1, l.goodList = i, 
                l.loading = !1, l.loadmore = e.data.nextCursor > 0, l.query = {
        ...
        queryCategoryList: function(t) {
            ...
            t && e.default.getStorecategoryList({
                ...
                a.setData({
                    ...
                    var l = t.data.categoryData.filter(function(t) {
                        return t.id == a.data.classifySelectedId;
                    });
                    if (l && l.length > 0 && (a.data.shopDefault.classifySelectedName = l[0].name, a.setData({
                        shopDefault: classifySelectedName
                    }), a.data.shopDefault.classifySelectedSecondId > 0 && "" == a.data.shopDefault.classifySelectedSecondName && l[0].categoryList && l[0].categoryList.length > 0)) {
                        var c = l[0].categoryList.filter(function(t) {
                            return t.id == a.data.shopDefault.classifySelectedSecondId;
                        });
                        c && c.length > 0 && a.setData({
                            classifySelectedSecondName: c[0].name.trim().split(" ")
                        });
                    }
                }
            }).catch(function(t) {
        ...
        addToCart: function(t) {
            ...
            wx.showLoading({
                ...
                if (wx.hideLoading(), 0 == t.status) {
                    ...
                    } else 6 != r.storeType && i.stock <= 0 ? s.showToast("该商品库存不足！") : e.default.addToCart({
                        goodsId: i.id,
                        quantity: 1
                    }).then(function(t) {
        ...
        setStoreDetail: function(t) {
            console.log("------------setStoreDetail-----------"), this.setData({
