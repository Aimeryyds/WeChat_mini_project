...
Page({
    ...
    getMoneyInfoList: function(a) {
        var o = this, n = getApp().globalData.userInfo.user_id, s = e.globalData.userInfo.user_money;
        t.getJSON("/User/account/user_id/" + n + "/page/" + a, function(t) {
            var e = t.data.result, a = o.data.accounts;
