...
var _createClass = function() {
    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function() {
            return {
                path: "/pages/classlist/classdetail/double?areaCode=" + this.areaCode + "&classId=" + this.classId + "&from=share&route=share"
            };
        }
    }, {
        key: "getDetailValue",
        value: function() {
            ...
            return e.areaCode && e.classId ? (this.areaCode = e.areaCode, void (this.classId = e.classId)) : t && t.area_code && e.classId ? (this.areaCode = t.area_code, 
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      ...
                      case 6:
                        ...
                        this.$broadcast(r, t, "double")) : (s = this.ABTest ? "onshow-event-new" : "onshow-event", 
                        this.$broadcast(s, "double")), this.getDetailValue(t);
...
Page(require("./../../../npm/wepy/lib/wepy.js").default.$createPage(ClassDetailDouble, "pages/classlist/classdetail/double"));