...
}, e = (module.exports = {}, window = require("../labrador/global.js"));
...
!function(e) {
    ...
    function u(e) {
        function r(o, i, a, c) {
            ...
            if ("throw" !== u.type) {
                ...
                return l && "object" === (void 0 === l ? "undefined" : t(l)) && w.call(l, "__await") ? Promise.resolve(l.__await).then(function(t) {
                    r("next", t, a, c);
                }, function(t) {
                    r("throw", t, a, c);
    ...
    var d, v = Object.prototype, w = v.hasOwnProperty, g = "function" == typeof Symbol ? Symbol : {}, m = g.iterator || "@@iterator", b = g.toStringTag || "@@toStringTag", L = "object" === ("undefined" == typeof module ? "undefined" : t(module)), x = e.regeneratorRuntime;
    if (x) L && (module.exports = x); else {
        ...
        x.isGeneratorFunction = function(t) {
            ...
            reset: function(t) {
                ...
                this.tryEntries.forEach(s), !t) for (var e in this) "t" === e.charAt(0) && w.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = d);
            },
            stop: function() {
                this.done = !0;
...
}("object" === (void 0 === e ? "undefined" : t(e)) ? e : "object" === ("undefined" == typeof window ? "undefined" : t(window)) ? window : "object" === ("undefined" == typeof self ? "undefined" : t(self)) ? self : void 0);