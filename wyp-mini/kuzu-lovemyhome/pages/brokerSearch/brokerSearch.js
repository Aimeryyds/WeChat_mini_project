...
Page({
    ...
    onLoad: function(e) {
        ...
        new t({
            ...
            a ? console.log(a) : (r.setData({
                ...
                historyRecord: wx.getStorageSync("self.data.historyBroker") || []
            }));
        });
    },
    cancelFn: function() {
    ...
    toListLink: function(a) {
        ...
        t.historyRecord(r), wx.redirectTo({
            url: "../broker_detail/brokerDetail?brokerId=" + e.brokerid + "&cityId=" + t.data.cityId + "&citycode=" + e.citycode
        });
    },
    bindconfirm: function(a) {
        ...
        t.data.keywordsVal = e, console.log("bindconfirm: ", e), wx.redirectTo({
            url: "../brokerList/brokerList?keyWords=" + e + "&searchType=0&cityId=" + t.data.cityId + "&searchName=" + e
        });
        var r = [ t.data.keywordsVal ];
        t.historyRecord(r);
    },
    search: function(t) {
        var e = this, r = a.globalData.url_host, o = {
            searchtype: 7,
            keywords: t
        };
        wx.request({
    ...
    historyLinkFn: function(a) {
        ...
        getCurrentPages();
        wx.redirectTo({
            url: "../brokerList/brokerList?keyWords=" + e.name + "&searchType=0&cityId=" + t.data.cityId + "&searchName=" + e.name
    ...
    historyRecord: function(a) {
        ...
        -1 == t.data.arrRecord.indexOf(t.data.keywordsVal) && (t.data.historyRecord.length < 10 ? t.data.historyRecord.unshift({
            ...
            value: a,
            id: t.data.historyRecord.length
        }))), wx.setStorageSync("self.data.historyBroker", t.data.historyRecord);
    },
    historyDelFn: function() {
        wx.clearStorageSync("self.data.historyBroker"), this.setData({
            historyRecord: []
        });
    }
});