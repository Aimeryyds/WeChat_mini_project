...
Page({
    data: {
        ...
        from: [ {
            ...
            text: "user_name",
            number: 200,
            placeholder: "请输入已绑定葛天出行账号申请人",
            type: !0
        }, {
            name: "手 机 号",
            text: "mobile",
            number: 11,
            placeholder: "请输入已绑定葛天出行账号的手机号",
            type: !0
        }, {
            name: "身份证号",
            text: "user_idno",
            number: 18,
            placeholder: "请输入已绑定葛天出行账号的身份证号",
            type: !0
        }, {
            name: "银行卡号 ",
            text: "cardno",
    ...
    formSubmit: function(n) {
        ...
        console.log(t), "" == t.user_name ? wx.showToast({
            title: "请输入已绑定葛天出行账号申请人",
            icon: "none",
            duration: 2e3
        }) : "" == t.mobile ? wx.showToast({
            title: "请输入已绑定葛天出行账号的手机号",
            icon: "none",
            duration: 2e3
        }) : "" == t.user_idno ? wx.showToast({
            title: "请输入已绑定葛天出行账号的身份证号",
            icon: "none",
            duration: 2e3
