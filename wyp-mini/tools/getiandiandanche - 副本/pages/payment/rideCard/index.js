...
Page({
    data: {
        cur: 0,
        cardList: [],
        shoumingList: [ "• 免押金骑行卡是为了保障正式用户的使用权益所采用的会员制服务;", "• 凡购买了免押金骑行卡的用户即属于葛天出行正式用户, 可享受免去支付额外的租车使用押金的服务;", "• 不同类型的免押金骑行卡对应的免押金天数(次数)不同;", "• 免押金骑行卡有效期从支付成功的当天开始计算, 购买成功后可到我的钱包--押金 查看有效期;", "• 免押金骑行卡超过有效期后, 需再次购买才能继续用车, 否则无法用车;" ],
        myHight: "",
        ishow: !0
    },
