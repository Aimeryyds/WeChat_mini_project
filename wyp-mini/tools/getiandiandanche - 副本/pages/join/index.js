...
var t, a = require("../../utils/https.js"), o = a.imgurl, n = (getApp(), 0), i = /^1[3456789]\d{9}$/;
...
Page(e({
    ...
    getpeople: function() {
        var e = this;
        wx.request({
            url: "https://api.51gtdc.com/app/Franchiser/GetFranchiserCount",
            data: "",
            header: {},
            method: "GET",
            dataType: "json",
    ...
    getcode: function() {
        var e = this;
        i.test(e.data.tel) ? a.req("User/GetCode", {
            account: e.data.tel,
            type: 6
        }, function(t, a) {
            if (0 == a.data.code) {
