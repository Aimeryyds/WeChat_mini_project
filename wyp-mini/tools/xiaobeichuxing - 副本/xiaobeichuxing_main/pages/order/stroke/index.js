...
Page({
    ...
    MyTripTrail: function(a, i) {
        var n = this, o = this, d = o.data.polyline, r = {
            vid: o.data.vid,
            orderno: o.data.orderno,
            stime: a,
            etime: i
        };
        t.req("Veh/MyTripTrail", r, function(t, a) {
            var i = a.data.data;
            console.log(a.data.data);
            var o = e.gcj_encrypt(i.slat, i.slng), r = e.gcj_encrypt(i.elat, i.elng);
            i.slat = o[1], i.slng = o[0], i.elat = r[1], i.elng = r[0];
            var s = i;
            if (n.setData({
                obj: s
                ...
                for (var c = s.list, l = [], u = [], g = 0; g < c.length; g++) {
                    var h = c[g], p = e.gcj_encrypt(h.lat, h.lng);
                    l.push({
                        latitude: p[1],
                        longitude: p[0]
                    }), 0 == g && u.push({
    ...
    PayOrder: function(e, a) {
        var i = this;
        1 != o ? t.req11("V2.0/Order/PayOrder", e, function(d, r) {
            if (0 == r.data.code) if (4 == e.paytype) {
                ...
                var a = e.data.data.amount, i = e.data.data.ridingtime, o = e.data.data.mile, d = e.data.data.stime.replace(/T/, " "), r = e.data.data.etime.substr(0, 19).replace(/T/, " "), s = e.data.data.costprice, c = e.data.data.dispatchamount, l = e.data.data.couponamount;
                wx.hideLoading(), wx.showToast({
                    ...
                    wx.redirectTo({
                        url: "../../index/endtrip/index?amount=" + a + "&ridingtime=" + i + "&mile=" + o + "&code=0&stime=" + d + "&etime=" + r + "&costprice=" + s + "&dispatchamount=" + c + "&couponamount=" + l + "&endtrip=1"
                    });
                }, 1500);
