...
Page({
    ...
    uploadFileImg: function(e, a, n, o, i, s) {
        var c = this, e = c.data.upImgList, a = wx.getStorageSync("uid"), u = wx.getStorageSync("token"), l = [], r = t.imgurlOne + "/FileResources/UploadImages";
        wx.showToast({
            title: "提交中...",
            duration: 1e4,
            mask: !0
        ...
        for (var d = 0; d < e.length; d++) !function(t) {
            wx.uploadFile({
                ...
                success: function(u) {
                    ...
                    console.log(r), l.push(r[0].file_resource_id), c.setData({
                        upImgL: l
