...
!function(t, n) {
    "object" === ("undefined" == typeof exports ? "undefined" : e(exports)) && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : t.ES6Promise = n();
}(void 0, function() {
    function t(t) {
    ...
    function b(t, e) {
        t._state === J && (t._state = R, t._result = e, L(_, t));
    }
    function w(t, e, n, r) {
    ...
    function j(t, e, r, o) {
        ...
        if (i) {
            if ((s = A(r, o)) === X ? (f = !0, u = s.error, s.error = null) : c = !0, e === s) return void b(e, a());
        } else s = o, c = !0;
        e._state !== J || (i && c ? y(e, s) : f ? b(e, u) : t === Q ? m(e, s) : t === R && b(e, s));
    }
    function E(t, e) {
        try {
            e(function(e) {
    ...
    var I = Math.random().toString(36).substring(16), J = void 0, Q = 1, R = 2, V = new S(), X = new S(), Z = 0;
