var a = require("../../../@babel/runtime/helpers/interopRequireDefault")(require("../../../@babel/runtime/helpers/defineProperty")), e = require("../../../utils/aesKey.js"), t = require("../../../utils/channel.js"), i = require("../../../utils/share.js"), n = require("../../../utils/mBuriedPoint.js"), s = getApp(), o = require("../../../utils/util.js"), r = require("../../../utils/dateUtils.js"), l = require("../../../utils/aes.js");
...
Page({
    data: {
        ...
        imgurl: {
            topImgUrl: s.globalData.test1Url + "/wxresource/P156/img/top.jpg",
            cpxq: s.globalData.test1Url + "/wxresource/P156/img/cpxq.jpg",
            cpxq2: s.globalData.test1Url + "/wxresource/P156/img/cpxq_02.jpg",
            cjwt1: s.globalData.test1Url + "/wxresource/P156/img/cjwt1.jpg",
            cjwt2: s.globalData.test1Url + "/wxresource/P156/img/cjwt2.jpg",
            cjwt3: s.globalData.test1Url + "/wxresource/P156/img/cjwt3.jpg",
    ...
    buy: function() {
        var a = this;
        (0, n.mBuriedPoint)("WX_Ins_Product_insure", "A100000013_平安e生保2020", "立即投保", "click"), 
    ...
    checkForm: function() {
        return 0 == o.isLegalName(this.data.applicant.name) ? (wx.showModal({
            ...
            content: "投保人本人身份证号有误"
        }), !1) : r.ages(this.data.applicant.birthday) > 50 ? (wx.showModal({
            content: "投保人年龄不能大于50周岁"
        }), !1) : r.ages(this.data.applicant.birthday) < 16 ? (wx.showModal({
            content: "投保人年龄不能小于16周岁"
        }), !1) : "1" != this.data.relationshipWithApplicant && r.ages(this.data.beibaoren.birthday) > 50 ? (wx.showModal({
            content: "被保人年龄不能大于50周岁"
        ...
        wx.request({
            ...
            success: function(a) {
                if (console.log(a), "00" == a.data.returnCode) {
                    ...
                    content: JSON.stringify(a.data.returnMsg)
                });
            },
            fail: function() {
                wx.hideToast();
    ...
    onShareAppMessage: function(a) {
        return "button" === a.from && console.log(a.target), {
            title: "抗击新冠疫情，公益保障免费领",
            path: "/pages/antiEpidemic/index/index" + (0, i.setShareUrl)()
        };
    }
});