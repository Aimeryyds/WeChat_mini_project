...
r = "undefined" == typeof window ? require("./Crypto").Crypto : window.Crypto, e = r.util, 
n = r.charenc, o = n.UTF8, n.Binary, a = [], s = [], i = r.Rabbit = {
    ...
    _keysetup: function(r) {
        ...
        t = 0;
        for (var n = 0; n < 4; n++) i._nextstate();
        for (n = 0; n < 8; n++) s[n] ^= a[n + 4 & 7];
    },
    _ivsetup: function(t) {
    ...
    _nextstate: function() {
        ...
        var n = [];
        for (e = 0; e < 8; e++) {
            var o = a[e] + s[e] >>> 0, i = 65535 & o, c = o >>> 16, u = ((i * i >>> 17) + i * c >>> 15) + c * c, y = ((4294901760 & o) * o >>> 0) + ((65535 & o) * o >>> 0) >>> 0;
            n[e] = u ^ y;
        }
