!function() {
    var n = "undefined" == typeof window ? require("./Crypto").Crypto : window.Crypto, o = n.pad = {};
    function t(n, o) {
    ...
    o.NoPadding = {
        ...
        pad: function(n, o) {
            for (var r = t(n, o), p = 1; p < r; p++) o.push(0);
            o.push(r);
        },
        unpad: r
    }, o.iso10126 = {
        pad: function(n, o) {
            for (var r = t(n, o), p = 1; p < r; p++) o.push(Math.floor(256 * Math.random()));
            o.push(r);
        },
        unpad: r
    }, o.pkcs7 = {
        pad: function(n, o) {
            for (var r = t(n, o), p = 0; p < r; p++) o.push(r);
        },
        unpad: r
    };
    var p = n.mode = {}, i = p.Mode = function(n) {
        n && (this._padding = n);
    };
    i.prototype = {
    ...
    a._doEncrypt = function(n, o, t) {
        for (var r = 4 * n._blocksize, p = 0; p < o.length; p += r) {
            if (0 == p) for (var i = 0; i < r; i++) o[i] ^= t[i]; else for (i = 0; i < r; i++) o[p + i] ^= o[p + i - r];
            n._encryptblock(o, p);
        }
    ...
    e._padding = o.NoPadding, e._doEncrypt = function(n, o, t) {
    ...
    d._padding = o.NoPadding, d._doEncrypt = function(n, o, t) {
    ...
    f._padding = o.NoPadding, f._doEncrypt = function(n, o, t) {
