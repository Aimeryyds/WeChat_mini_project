...
Page({
    ...
    wxpay: function() {
        (0, a.mBuriedPoint)("WX_Ins_Product_pay", "A100000015_平安抗癌卫士2020", "否，付款", "click");
        var o = new Object();
        ...
        console.log(s), wx.request({
            url: t.globalData.test2Url + "/miniapp/wxpay?c=" + t.globalData.fromChannel,
            data: s,
            method: "POST",
            header: {
    ...
    occupation: function() {
        var e = t.globalData.wm1Url + "/mgr/makePdf.do?filename=A100000015-22.pdf";
        o.getStaticPage(e);
    },
    onLoad: function(e) {
