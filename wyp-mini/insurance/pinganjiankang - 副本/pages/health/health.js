...
Page({
    ...
    wxpay: function() {
        ...
        var o = (0, a.getFromParams)(), i = o.from_openId, c = o.from_unionId;
        t.from_openId = i, t.from_unionId = c, t.c = (0, e.getFromChannel)();
    ...
    occupation: function() {
        var a = n.globalData.baseUrl + "/wxresource/A000000021/static/occupation_A000000021.pdf";
        t.getStaticPage(a);
    },
    onLoad: function(a) {
        this.setData({
