...
Page({
    data: {
        ...
        imgurl: {
            topImgUrl: o.globalData.wm1Url + "/wxresource/P157/img/top.jpg",
            cpxq: o.globalData.wm1Url + "/wxresource/P157/img/cpxq.png",
            cpxq2: o.globalData.wm1Url + "/wxresource/P157/img/cpxq_02.png",
            cpxq3: o.globalData.wm1Url + "/wxresource/P157/img/cpxq_03.png",
            cpxq4: o.globalData.wm1Url + "/wxresource/P157/img/cpxq_04.png",
            cpxq5: o.globalData.wm1Url + "/wxresource/P157/img/cpxq_05.png",
            cjwt: o.globalData.wm1Url + "/wxresource/P157/img/cjwt.png",
            cjwt2: o.globalData.wm1Url + "/wxresource/P157/img/cjwt_02.png",
            cjwt3: o.globalData.wm1Url + "/wxresource/P157/img/cjwt_03.png",
    ...
    buy: function() {
        var a = this;
        (0, n.mBuriedPoint)("WX_Ins_Product_insure", "A100000014_e生保（保证续保版）", "立即投保", "click"), 
    ...
    checkForm: function() {
        return 0 == s.isLegalName(this.data.applicant.name) ? (wx.showModal({
            ...
            content: "投保人本人身份证号有误"
        }), !1) : this.ages(this.data.applicant.birthday) >= 51 ? (wx.showModal({
            content: "投保人年龄不能大于50岁"
        }), !1) : r.ages(this.data.applicant.birthday) < 16 ? (wx.showModal({
            content: "投保人年龄不能小于16岁"
        }), !1) : "1" != this.data.relationshipWithApplicant && this.ages(this.data.beibaoren.birthday) >= 51 ? (wx.showModal({
            content: "被保人年龄不能大于50岁"
        }), !1) : "1" != this.data.relationshipWithApplicant && r.dateDiffInDays(this.data.beibaoren.birthday, new Date()) < 28 ? (wx.showModal({
    ...
    validate: function() {
        ...
        delete a.applicant.hasSocialSecurity, delete a.insurants[0].hasSocialSecurity, console.log("2", JSON.stringify(a)), 
        console.log("1", a);
    ...
    planChange: function(a) {
        ...
        Object.assign(o, t), this.setData({
            plans: i,
            coverages: o
        }), console.log("3", this.data.coverages), this.calcPremium();
    },
    ...
    onSet: function() {
        wx.cloud.database().collection("userInfoCache").doc(this.data.openId + "_userInfoCache_A100000014").set({
            data: {
    ...
    onInit: function() {
        ...
        (console.log("onQuery"), this.data.openId) && wx.cloud.database().collection("userInfoCache").where({
            _id: this.data.openId + "_userInfoCache_A100000014"
        }).get({
            success: function(e) {
                console.log(e);
                var t = e.data[0];
    ...
    getScrollTop: function(a) {
        var e = a.detail.current.detail.scrollTop, t = parseInt(this.data.navcur);
        console.log("navcur" + t);
        var i = this.data.tops[t].top;
    ...
    onLoad: function(a) {
        ...
        this.calcPremium(), wx.showLoading({
            ...
            wx.hideLoading();
        }, 4e3), console.log(this.data.openId), wx.getSystemInfo({
            success: function(a) {
    ...
    openPdf: function(a) {
        var e = o.globalData.wm1Url + a.target.dataset.pdfurl;
        s.getStaticPage(e);
    },
    toKefu: function() {
        wx.navigateTo({
    ...
    onShareAppMessage: function(a) {
        return "button" === a.from && console.log(a.target), {
            title: "平安e生保（保证续保版）",
            path: "/pages/P157/index/index" + (0, i.setShareUrl)()
        };
    }
});