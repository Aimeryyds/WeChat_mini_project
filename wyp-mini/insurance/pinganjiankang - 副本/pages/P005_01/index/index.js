...
Page({
    data: {
        ...
        imgurl: {
            topImgUrl: n.globalData.test1Url + "/wxresource/P005_01/img/top.jpg",
            cpxq1: n.globalData.test1Url + "/wxresource/P005_01/img/cpxq_01.jpg",
            cpxq2: n.globalData.test1Url + "/wxresource/P005_01/img/cpxq_02.jpg",
            cpxq3: n.globalData.test1Url + "/wxresource/P005_01/img/cpxq_03.jpg",
            cpxq4: n.globalData.test1Url + "/wxresource/P005_01/img/cpxq_04.jpg",
            cpxq5: n.globalData.test1Url + "/wxresource/P005_01/img/cpxq_05.jpg",
            cjwt: n.globalData.test1Url + "/wxresource/P005_01/img/cjwt.jpg",
    ...
    checkForm: function() {
        return 0 == o.isLegalName(this.data.applicant.name) ? (wx.showModal({
            ...
            content: "投保人本人身份证号有误"
        }), !1) : s.ages(this.data.applicant.birthday) > 60 ? (wx.showModal({
            content: "投保人年龄不能大于60岁"
        }), !1) : s.ages(this.data.applicant.birthday) < 16 ? (wx.showModal({
            content: "投保人年龄不能小于16岁"
        }), !1) : "1" != this.data.relationshipWithApplicant && s.ages(this.data.beibaoren.birthday) > 60 ? (wx.showModal({
    ...
    validate: function() {
        ...
        delete e.applicant.hasSocialSecurity, delete e.insurants[0].hasSocialSecurity, console.log(JSON.stringify(e)), 
        console.log(e);
        var o = this, s = (0, a.getChannelKey)(), l = (0, t.getFromChannel)();
        wx.request({
            url: n.globalData.test2Url + "/outChannel/validate.do?c=" + l,
            data: {
            ...
            success: function(e) {
                if (console.log(e), "00" == e.data.returnCode) {
                    ...
                    content: JSON.stringify(e.data.returnMsg)
                });
            },
            fail: function() {
                wx.hideToast();
    ...
    tabPlan: function(e) {
        ...
        "100" == a ? t = "174元/年起" : "300" == a && (t = "202元/年起"), this.setData({
            tabplan: a,
            price: t
        });
    },
    ...
    planChange: function(e) {
        ...
        for (var n in i) i[n].sumInsured == a ? (i[n].checked = !0, Object.assign(t, i[n]), 
    ...
    onSet: function() {
        wx.cloud.database().collection("userInfoCache").doc(this.data.openId + "_userInfoCache_A000000042").set({
            data: {
    ...
    onInit: function() {
        ...
        (console.log("onQuery"), this.data.openId) && wx.cloud.database().collection("userInfoCache").where({
            _id: this.data.openId + "_userInfoCache_A000000042"
        }).get({
            success: function(a) {
                console.log(a);
                var t = a.data[0];
    ...
    onShareAppMessage: function(e) {
        return "button" === e.from && console.log(e.target), {
            title: "平安e生保PLUS",
            path: "/pages/P005_01/index/index" + (0, i.setShareUrl)()
        };
    }
});