...
Page({
    data: (e = {
        ...
        insuredAreasData: [ {
            ...
            name: "私人健康顾问",
            value: "体检报告解读+运动/健康/用药指导+视频医生问诊+送药上门（药费自理），不限次"
        }, {
            name: "保障区域",
            value: "中国大陆（不含港澳台）"
        }, {
    ...
    onSet: function() {
        wx.cloud.database().collection("userInfoCache").doc(this.data.openId + "_userInfoCache_A100000037").set({
            data: {
    ...
    onShareAppMessage: function(e) {
        return "button" === e.from && console.log(e.target), {
            title: "i康保·百万医疗（慢病版）",
            path: "/pages/P171/index/index" + (0, r.setShareUrl)()
        };
    },
