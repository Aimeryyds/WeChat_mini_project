...
Page({
    ...
    onLoad: function() {
        ...
        e.globalData.userInfo ? this.setData({
            ...
            success: function(n) {
                e.globalData.userInfo = n.userInfo, a.setData({
                    userInfo: n.userInfo,
                    hasUserInfo: !0
                });
            }
    ...
    getRedPacketStandard: function(e) {
        console.log(e), 1 == res.data.code ? (console.log(res.data), wx.sendBizRedPacket({
    ...
    getRedPacketText: function(e) {
        var a = JSON.parse(this.data.scene);
        wx.sendBizRedPacket({
