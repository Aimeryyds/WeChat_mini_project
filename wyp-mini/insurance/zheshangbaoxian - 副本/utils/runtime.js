...
!function(r) {
    ...
    function f(t, r, e) {
        ...
        return function(i, a) {
            ...
            for (e.method = i, e.arg = a; ;) {
                ...
                var f = n(t, r, e);
                if ("normal" === f.type) {
                    if (o = e.done ? O : _, f.arg === S) continue;
                    return {
                        value: f.arg,
                        done: e.done
                    };
    ...
    function h(t, r) {
        ...
        if (e === v) {
            if (r.delegate = null, "throw" === r.method) {
                if (t.iterator.return && (r.method = "return", r.arg = v, h(t, r), "throw" === r.method)) return S;
    ...
    var v, m = Object.prototype, g = m.hasOwnProperty, w = "function" == typeof Symbol ? Symbol : {}, L = w.iterator || "@@iterator", x = w.asyncIterator || "@@asyncIterator", b = w.toStringTag || "@@toStringTag";
    r.wrap = e;
    ...
    r.isGeneratorFunction = function(t) {
        ...
        return this;
    }, r.AsyncIterator = u, r.async = function(t, n, o, i) {
        var a = new u(e(t, n, o, i));
        return r.isGeneratorFunction(n) ? a : a.next().then(function(t) {
            return t.done ? t.value : a.next();
        });
    }, c(P), P[b] = "Generator", P[L] = function() {
        return this;
    }, P.toString = function() {
