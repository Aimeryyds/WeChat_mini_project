...
var team = function(_wepy$page) {
    ...
    function team() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = team.__proto__ || Object.getPrototypeOf(team)).call.apply(_ref, [ this ].concat(args))), 
        _this), _this.props = {}, _this.components = {
            net: _net2.default,
            backHome: _backHome2.default
        }, _this.config = {
            navigationBarTitleText: "执笔投顾团队"
        }, _this.data = {
            intro: "",
            datas: []
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(team, "pages/myService/team"));