...
var explain = function(_wepy$page) {
    _inherits(explain, _wepy$page);
    function explain() {
        var _ref;
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = explain.__proto__ || Object.getPrototypeOf(explain)).call.apply(_ref, [ this ].concat(args))), 
        _this), _this.props = {}, _this.components = {
            net: _net2.default,
            backHome: _backHome2.default
        }, _this.config = {
            navigationBarTitleText: "产品说明"
        }, _this.data = {
            datas: {}
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return (0, _myService.getGuestList)();
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(explain, "pages/myService/explain"));