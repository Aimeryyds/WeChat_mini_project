...
var aboutUs = function(_wepy$page) {
    ...
    function aboutUs() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = aboutUs.__proto__ || Object.getPrototypeOf(aboutUs)).call.apply(_ref, [ this ].concat(args))), 
        _this), _this.config = {
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(aboutUs, "pages/mine/aboutUs"));