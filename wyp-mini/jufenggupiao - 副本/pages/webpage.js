...
var webpage = function(_wepy$page) {
    ...
    function webpage() {
        ...
        _this), _this.props = {}, _this.config = {}, _this.data = {
            weburl: ""
    ...
    _createClass(webpage, [ {
        ...
        value: function onLoad(options) {
            ...
            if (options.weburl.indexOf("dia") >= 0) {
                (0, _api.APP_SHARE_COUNT)({
                    params: {
                        behavior: "visit_stock"
                    }
                });
            }
...
Page(require("./../npm/wepy/lib/wepy.js").default.$createPage(webpage, "pages/webpage"));