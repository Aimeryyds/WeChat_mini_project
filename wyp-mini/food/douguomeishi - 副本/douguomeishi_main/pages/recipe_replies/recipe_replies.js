...
Page({
    ...
    request: function() {
        if (!(this.data.recipeID.length <= 0)) {
            ...
            var o = this, n = "https://wapi.douguo.com/wxapp/recipe/commentdetail/" + this.data.offset + "/" + this.data.num;
            t.request(n, {
    ...
    onShareAppMessage: function() {
        return {
            title: "豆果美食",
            desc: "豆果美食 开启美味生活",
            path: "/pages/recipe_replies/recipe_replies?recipeID=" + this.data.recipeID + "&commentID=" + this.data.commentId
        };
    },
    ...
    commentFavoViewPressed: function(t) {
        ...
        if (wx.getStorageSync("user")) {
            ...
            e.unfavoRecipe({
                id: a
            })) : (this.data.comment.like = !0, this.data.comment.like_count += 1, e.favoRecipe({
                id: a
            })), this.setData({
