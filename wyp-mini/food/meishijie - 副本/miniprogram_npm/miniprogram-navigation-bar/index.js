...
module.exports = function(e) {
    ...
    var n = __wxConfig.global.window, a = n.navigationBarBackgroundColor, o = n.navigationBarTextStyle, r = n.navigationBarTitleText, l = wx.getSystemInfoSync().statusBarHeight, i = "white" === o || "" === o ? "./images/nav_icon_white.png" : "./images/nav_icon_black.png", u = "" === r ? "WeChat" : r, s = "" === a ? "background-color:#000;" : "background-color:" + a + ";", c = "" === o ? "color: white;" : "color:" + o + ";";
    Component({
        properties: {
            enable: {
                type: Boolean,
