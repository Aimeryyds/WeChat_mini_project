    ...
    sendPl: function(t) {
        ...
        console.log(t.detail), wx.request({
            ...
            data: {
                ...
                rid: e.data.option.id,
                cid: e.data.option.cid,
            ...
            success: function(a) {
                console.log("提交评论："), console.log(a), 10 == a.data.code ? (e.showToastss({
                    title: a.data.msg,
                    duration: 2e3
                }), setTimeout(function() {
                    wx.navigateBack(1);
    ...
    tapFavBtn: function(t) {
        ...
        if (console.log("index:"), console.log(o), 1 == e.data.requesting) ; else if (e.setData({
            ...
            "getUserInfo:fail auth deny" == t.detail.errMsg || wx.request({
                ...
                success: function(t) {
                    var i = t.data.data.wx_sesson, d = n.detail.encryptedData, r = n.detail.iv;
                    wx.setStorage({
                        key: "wx_sesson",
                        data: i
                    }), wx.request({
