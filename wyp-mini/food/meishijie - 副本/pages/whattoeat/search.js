...
Page({
    ...
    formSubmit: function(e) {
        ...
        this.recordSearched(e, a), "" == a || void 0 == a ? this.showToastss({
            ...
            wx.navigateTo({
                url: "../whattoeat/search_result_wz?words=" + a + "&scene_id=" + (s.data.option.scene_id || "")
            });
        }, 50));
    },
    ...
    recordSearched: function(e, s) {
        ...
        if ("" == a || void 0 == a) ; else {
            for (var o = this.data.searchedWords_cj_wz, d = 0; d < o.length; d++) o[d] == a && (o.splice(d, 1), 
            d -= 1);
            var i = (a + "||s$@s||" + o.join("||s$@s||")).split("||s$@s||").slice(0, 10).join("||s$@s||");
            wx.setStorage({
                key: "searchedWords_cj_wz",
                data: i
            });
    ...
    inputIng: function(s) {
        ...
        "" == a ? t.data.searchRequesting ? setTimeout(function() {
            ...
            url: e.globalData.newlocalhost + "/knowledge/point",
            data: {
                format: "json",
