(global.webpackJsonp = global.webpackJsonp || []).push([ [ "pages/worldCupSchedule/worldCupSchedule" ], {
    ...
    "./src/pages/worldCupSchedule/index.js": function(e, a, s) {
        s("./src/pages/worldCupSchedule/index.scss");
        var t = s("./src/scripts/utils/index.js");
        Page({
            data: {
                url: "https://sports.qq.com/kbsweb/qb/leagues.htm#/4/schedule"
            },
            onLoad: function(e) {
                var a = e.type, s = void 0 === a ? "schedule" : a, p = (0, t.decodeUntilEqual)(s);
                this.setData({
                    url: "https://sports.qq.com/kbsweb/qb/leagues.htm#/4/" + p
                });
            },
            onShareAppMessage: function(e) {
                console.warn(e.webViewUrl);
                return (0, t.getShareAppMessage)({
                    title: "2018俄罗斯世界杯"
                });
            }
        });
    },
    "./src/pages/worldCupSchedule/index.scss": function(e, a, s) {},
    22: function(e, a, s) {
        e.exports = s("./src/pages/worldCupSchedule/index.js");
    }
}, [ [ 22, "chunks/runtime", "chunks/vendors", "chunks/scripts" ] ] ]);