var e = require("../../pass_requestapi/regUser"), t = require("../../pass_utils/clearInputFn"), n = require("../../pass_utils/toastFn"), a = require("../../pass_utils/regValidate"), s = require("../../pass_config");
...
Page({
    ...
    ignoreSetinfo: function() {
        ...
        try {
            ...
            s.isWebview ? wx.navigateTo({
                url: "/pages/pass_jump/jump?delta=" + (t.length - e + 2) + "&encryptInfo=" + (n.encryptInfo || "")
            }) : e && wx.navigateBack({
                delta: t.length - e + 1
            });
        } catch (e) {
